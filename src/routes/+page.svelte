<script>
	...
	// --- Terms/Privacy/Data Deletion Modal Logic ---
...
<main>
	...
	<nav
		class="navbar navbar-expand-lg shadow-sm py-3 fixed-top"
		style="background:#dd815e; z-index:1050;"
	>
		<div class="container-fluid">
			<a class="navbar-brand d-flex align-items-center gap-2" href="/" style="color:#fff;">
				<img
					...
					width="36"
					height="36"
					style="border-radius:8px; transition:transform 0.3s cubic-bezier(0.4,0,0.2,1);"
					bind:this={appIcon}
				/>
				<span
					class="fw-bold align-items-center d-flex"
					style="color:#fff; height:45px; line-height:36px; font-size:1.6rem;">INET-READY</span
				>
				<span
					class="d-none d-md-inline align-items-center d-flex"
					style="color:#fff; height:36px; line-height:36px;"
				>
					Your Heat Check for Safe and Informed Travel</span
				>
			</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarNav" bind:this={navbarCollapse}>
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="#features" style="color:#fff;"
							>Features</a
						>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						<button
							...
							style="background:#fff; color:#dd815e; border:none; border-radius:50px; font-weight:600;"
							on:click={navigateToApp}>Get Started</button
						>
					</li>
				</ul>
			</div>
	...
	>
		<div class="hero-content w-100">
			<video
				src="https://cdnl.iconscout.com/lottie/premium/thumb/avoid-direct-sun-animation-download-in-lottie-json-gif-static-svg-file-formats--cooling-air-herself-fan-waving-heat-stroke-danger-pack-people-animations-9123129.mp4"
				autoplay
				loop
				muted
				playsinline
				style="max-width:600px; width:100%; height:auto; border:none; background:transparent; box-shadow:none;"
			></video>
			...
			>
				INET-READY keeps you safe and healthy on the go with real-time heat alerts, personalized
				health insights, and secure medical data—all in one easy-to-use platform.
			</p>
			<button
				class="btn px-5 py-3 cta-button get-started-vibrate"
				style="background:#dd815e; color:#fff; border-radius:50px; font-weight:700; font-size:1.2rem;"
				on:click={navigateToApp}>Get Started</button
			>
		</div>
	</section>
	...
	<section id="features" class="features py-5" style="background:#f5f5f7;">
		<div class="container">
			<h2 class="mb-4 text-center" style="color:#dd815e; font-weight:700; font-size:2.5rem;">
				How INET-READY Helps You
			</h2>
			<div
				id="featureCarousel"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<div class="d-flex justify-content-center">
							<div
								class="feature-card inet-orange d-flex flex-column justify-content-center align-items-center text-center p-4 rounded position-relative"
								style="min-width:300px; max-width:400px; width:100%; margin:0 1rem; min-height:320px;"
							>
								<div class="feature-icon-topright"><i class="bi bi-thermometer-sun"></i></div>
								<h5 class="fw-bold mb-2 w-100" style="word-break:break-word;">
									Real-Time Heat Index
								</h5>
								<p class="w-100" style="word-break:break-word;">
									Get up-to-date heat index forecasts for your city, powered by OpenMeteo and
									geospatial data.
								</p>
							</div>
						</div>
					...
					<div class="carousel-item">
						<div class="d-flex justify-content-center">
							...
							>
								...
								<p class="w-100" style="word-break:break-word;">
									Receive tailored health risk insights and travel advice based on your medical
					...
					<div class="carousel-item">
						<div class="d-flex justify-content-center">
							...
							>
								...
								<p class="w-100" style="word-break:break-word;">
									Your medical data is encrypted and securely managed—privacy is our top priority.
								</p>
							</div>
						</div>
					</div>
					<div class="carousel-item">
						<div class="d-flex justify-content-center">
							...
							>
								...
								<p class="w-100" style="word-break:break-word;">
									Receive timely alerts about heat risks and health reminders wherever you are.
								</p>
							</div>
						</div>
					</div>
					<div class="carousel-item">
						<div class="d-flex justify-content-center">
							...
							>
								...
								<p class="w-100" style="word-break:break-word;">
									Get personalized travel health tips based on your current or planned destinations.
								</p>
							</div>
						</div>
					</div>
					<div class="carousel-item">
						<div class="d-flex justify-content-center">
							...
							>
								...
								<p class="w-100" style="word-break:break-word;">
									Securely store and access your medical info and travel preferences anytime,
									anywhere.
								</p>
							</div>
						</div>
		...
		<div class="responsive-container-block outer-container" style="background:#fff;">
			<div class="responsive-container-block inner-container">
				...
				<p class="text-blk section-subhead-text">
					The INET-READY team brings together expertise in project management, frontend, backend,
					QA, and research to deliver a safer travel experience.
				</p>
				<div
					class="responsive-container-block"
					style="justify-content:center; gap:2rem; flex-wrap:wrap;"
				>
					<!-- Alyssa Mae Abac -->
					<div class="card dev-card">
						<div class="img-wrapper portrait-header">
							<img
								src="https://scontent.fmnl9-4.fna.fbcdn.net/v/t39.30808-1/495262217_3787895071428231_6510113284719315269_n.jpg?stp=cp6_dst-jpg_s200x200_tt6&_nc_cat=105&ccb=1-7&_nc_sid=1d2534&_nc_eui2=AeG8Km6yYzmTR-eYef0uKi_NwpI2en4CDivCkjZ6fgIOK90THDhrfB1cqcQgLxlxLd5W1BNj3sNFkYLKT-H3nbx8&_nc_ohc=ewMcjaW4PcoQ7kNvwHqSDjG&_nc_oc=AdnxAoZbNA6-Gx0bBL4YfKecD9Bo3UHWAKeN779qCiDUyazM1EOLptFenG7AGqdkds0&_nc_zt=24&_nc_ht=scontent.fmnl9-4.fna&_nc_gid=14i2lCz7n3wr0SheVfVz5Q&oh=00_AfLsbQ8ZrLrDilE-WP4EGNloBGSwph9NGOVzlkfj9k30AQ&oe=681FEA1B"
								alt="Alyssa Mae Abac"
							/>
							<div class="vignette">
			...
			<div class="row align-items-center flex-column-reverse flex-md-row">
				<div class="col-md-6 text-center text-md-start">
					...
					<p style="font-size:1.1rem; color:#fff;">
						INET-READY is a modern, privacy-focused platform for travelers. We combine real-time
						weather, health risk insights, and secure data management to help you travel smarter and
						safer—whether for business or leisure.
					</p>
				</div>
				<div class="col-md-6 mb-4 mb-md-0 text-center">
					<img
						...
						style="max-width:180px; background:transparent; border:none;"
					/>
				</div>
			</div>
		</div>
	...
	<section class="get-started py-5" style="background:#fff;">
		<div class="container text-center">
			...
			<p class="mb-4" style="font-size:1.1rem; color:#555;">
				Create your free account and get instant access to personalized travel health tools and
				notifications.
			</p>
			<button
				class="btn px-5 py-3 cta-button get-started-vibrate"
	...
	<footer id="contact" class="border-0 py-4 mt-5" style="background:#dd815e;">
		<div class="container">
			<div class="row gy-4">
				<!-- Title Column -->
				<div
					class="col-12 col-md-3 text-center text-md-start mb-3 mb-md-0 d-flex flex-column align-items-center align-items-md-start"
				>
					<div class="d-flex align-items-center gap-2 mb-2 mb-md-0">
						...
						/>
						<span
							class="fw-bold align-items-center d-flex footer-title"
							style="color:#fff; font-size:1.6rem; height:45px; line-height:36px;">INET-READY</span
						>
					</div>
				</div>
				<!-- Contact Column -->
				<div
					class="col-12 col-md-3 text-center text-md-start mb-3 mb-md-0 d-flex flex-column align-items-center align-items-md-start footer-col-uniform"
				>
					...
					<div class="d-flex align-items-center mb-2 footer-uniform-text" style="gap:0.5rem;">
						...
						<a
							...
							style="color:#fff;">GitHub</a
						>
					</div>
					<div class="d-flex align-items-center mb-2 footer-uniform-text" style="gap:0.5rem;">
						<i class="bi bi-envelope-fill" style="color:#fff; font-size:1.3rem;"></i>
						<a href="mailto:info@inet-ready.com" class="text-decoration-none" style="color:#fff;"
							>Email</a
						>
					</div>
					<div class="d-flex align-items-center mb-2 footer-uniform-text" style="gap:0.5rem;">
				...
				>
					...
					<a
						href="#"
						class="text-decoration-none mb-1 footer-uniform-text"
						style="color:#fff;"
	...
	>
		...
		>
			<button
				...
				style="position:absolute;top:1.1rem;right:1.1rem;background:none;border:none;font-size:2rem;color:#c26744;cursor:pointer;z-index:10;"
			...
			{:else if modalType === 'privacy'}
				<PrivacyContent />
			{:else if modalType === 'data-deletion'}
				<DataDeletionContent />
			{/if}
		</div>
	</div>
...
<style>
	...
	.close-modal-btn:hover {
		color: #dd815e;
		background: rgba(221, 129, 94, 0.08);
		border-radius: 50%;
	...
	.inet-orange {
		...
		color: #fff !important;
		box-shadow: 0 2px 8px rgba(221, 129, 94, 0.1);
	}
	.feature-card h5,
	.feature-card p {
		color: #fff !important;
