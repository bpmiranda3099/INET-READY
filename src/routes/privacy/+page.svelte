<script>
  // No JS needed for static policy
</script>

<svelte:head>
  <title>Privacy Policy | INET-READY</title>
  <meta name="description" content="Privacy Policy for INET-READY - Your Heat Check for Safe and Informed Travel." />
</svelte:head>
