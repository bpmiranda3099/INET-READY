...
try {
    ...
    $userFeedbackQuery = "SELECT * FROM userfeedback";
    ...
    $adminFeedbackQuery = "SELECT * FROM adminfeedback";
		...
		<div class="navbar-collapse collapse">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
						<div class="col">
							<h1 class="h3 mb-3"><strong>User and Administrator</strong> Feedback </h1>
						</div>
						<div class="col">
                            ...
                            <div class="card flex-fill">
                                <div class="card-header">
                                    <select id="tableSelect" class="form-control" onchange="showSelectedTable()">
                                        ...
                                        <option value="userFeedbackTable">User Feedback</option>
                                        <option value="adminFeedbackTable">Admin Feedback</option>
                                    </select>
                                </div>
                                                ...
                                                <?php foreach ($userFeedbackData as $data): ?>
                                                    <tr>
                                                        <td style="padding-left: 0px; padding-right: 0px;">
                                                            <div class="d-flex">
                                                                <a href="#" class="btn btn-link check-square" data-id="<?= htmlspecialchars($data['feedback_id']) ?>" data-table="userFeedbackTable">
                                                                    <i class="align-middle" data-feather="check-square" style="width: 20px; height: 20px;"></i>
                                                                </a>
                                                                <a href="#" class="btn btn-link x-square" data-id="<?= htmlspecialchars($data['feedback_id']) ?>" data-table="userFeedbackTable">
                                                                    <i class="align-middle" data-feather="x-square" style="width: 20px; height: 20px;"></i>
                                                                </a>
                                                            </div>
                                                        </td>
                                            ...
                                            <?php if (!empty($adminFeedbackData)): ?>
                                                <?php foreach ($adminFeedbackData as $data): ?>
                                                    <tr>
                                                        <td style="padding-left: 0px; padding-right: 0px;">
                                                            <div class="d-flex">
                                                                <a href="#" class="btn btn-link check-square" data-id="<?= htmlspecialchars($data['feedback_id']) ?>" data-table="adminFeedbackTable">
                                                                    <i class="align-middle" data-feather="check-square" style="width: 20px; height: 20px;"></i>
                                                                </a>
                                                                <a href="#" class="btn btn-link x-square" data-id="<?= htmlspecialchars($data['feedback_id']) ?>" data-table="adminFeedbackTable">
                                                                    <i class="align-middle" data-feather="x-square" style="width: 20px; height: 20px;"></i>
                                                                </a>
                                                            </div>
                                                        </td>
